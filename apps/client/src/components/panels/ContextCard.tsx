        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className={`text-[11px] font-medium ${theme === 'light' ? 'text-slate-600' : 'text-textSecondary'}`}>
                {primaryReason.subtitle}
              </p>
            </div>
          </div>
          ...
          <div
            className={`p-2.5 rounded-xl border text-xs leading-relaxed ${
              isLooped
                ...
                : theme === 'light'
                ? 'bg-sky-100/70 border-sky-300 text-sky-950 font-medium'
          ...
          <div className="space-y-1.5 pt-1">
            <div className="flex items-center justify-between text-xs font-semibold">
              ...
              <span className="font-mono text-amber-500 font-bold">
                ~{Math.max(1, holdEst - Math.floor((train.slowDuration || 0) / 60))} min remaining
              </span>
            </div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-200 dark:border-slate-800/80 text-xs">
          ...
          {train.nextStation && (
            <div className="flex items-center gap-1 text-[11px]">
              ...
              <span className={theme === 'light' ? 'text-slate-500 font-mono' : 'text-textSecondary font-mono'}>
                ({train.nextStation.distanceKm} km)
              </span>
